...
//////////////////////////////////////////////////////////////////////////////////////
    ...
    $(document).on('click', '.new', function(){
        if(count == 1){
            for(let i=0; i<8; i++){
                $('.new_section > .items_area')
                    .append(
                        '<div class="item"><div class="img_box"><img src="img/main/new1.png" alt="" id="new_img" ></div><div class="item_txt"><h4>SAMPLE</h4><h5>상품요약 설명</h5><h5><del>000,000원</del></h5><h4>000,000원</h4></div>')
            }
            count++
        }
    })
...
// 신상품 더보기
    $(document).on('click', '.best', function(){
        if(count == 1){
            for(let i=0; i<8; i++){
                $('.best_section > .items_area')
                    .append(
                        '<div class="item"><div class="img_box"><img src="img/main/best1.png" alt="" id="best_img" ></div><div class="item_txt"><h4>SAMPLE</h4><h5>상품요약 설명</h5><h5><del>000,000원</del></h5><h4>000,000원</h4></div>')
            }
            count++
        }
    })
